...
pull requests, discussions, etc.) and also applies when an individual
...
may be reported to the project maintainers via the project's GitHub
Security Advisory channel. All complaints will be reviewed and
